...
//It's not really faster, just less computations so no not really.
function findFourthFaster(numbers) {
  return numbers[3];
}
...
// ANSWER: They are both dependent on the size of the string.
